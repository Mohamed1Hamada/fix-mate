import 'package:fixmate/core/helper/get_responsive_font_size.dart';
...
class AppTextStyles {
  ...
  static TextStyle title16Black87W600 = TextStyle(
    color: Colors.black87,
    fontWeight: FontWeight.w600,
    fontSize: getResponsiveFontSize(fontSize: 16),
  );
  static TextStyle title14Grey600 = TextStyle(
